...
export const UNKNOWN_NETWORK_STATUS: LedgerStatus = { connected: false }
...
// interval.
const unreachableStatus = (last: LedgerStatus, reason: string): LedgerStatus => ({
  connected: false,
...
export const useWalletServiceStatus = (
  ...
  return useMemo(() => {
    const reported = query.data ?? UNKNOWN_NETWORK_STATUS
